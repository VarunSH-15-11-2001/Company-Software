...
def apps():
    ...
    if datafile is not None:
        try:
            ...
            input_col,fig_col,gender_col,dept_col,corr_col = c.tabs(["Attrition Count","Attrition Percentage","Gender-wise Analysis","Dept-Wise Analysis","Correlation between attributes"])
            fig = plt.figure()
